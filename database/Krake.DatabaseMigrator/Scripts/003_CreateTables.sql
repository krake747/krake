...
(
    ...
    [CountryIso2] NVARCHAR
(
    2
) NULL,
    [CountryIso3] NVARCHAR
(
    3
) NULL
    );
...
(
    ...
    CONSTRAINT [PK_InstrumentPrices] PRIMARY KEY
(
    [
    InstrumentId],
[
    ...
    CONSTRAINT [FK_Instruments] FOREIGN KEY
(
[
    InstrumentId]
) REFERENCES [Portfolios].[Instruments]
(
[
    Id]
)
